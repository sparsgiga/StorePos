...
namespace StorePos.Persistence.Migrations
{
    ...
    [Migration("20260827100650_AddManualProductCodeSequence")]
    partial class AddManualProductCodeSequence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StorePos.Domain.Aggregates.Sale.Sale", b =>
                {
                    ...
                    b.Property<int>("CompletionVersion")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StorePos.Domain.Aggregates.Sale.SalePayment", b =>
                {
                    ...
                    b.HasIndex("SaleId", "CompletionVersion");
            ...
            modelBuilder.Entity("StorePos.Persistence.Sequences.ManualProductCodeSequence", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");

                    b.Property<long>("NextCode")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ManualProductCodeSequence", "dbo", t =>
                        {
                            t.HasCheckConstraint("CK_ManualProductCodeSequence_NextCode", "[NextCode] >= 1000");

                            t.HasCheckConstraint("CK_ManualProductCodeSequence_Singleton", "[Id] = 1");
                        });
                });
